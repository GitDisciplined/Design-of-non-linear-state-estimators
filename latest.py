...
X0=np.array([0,0,90,90,0,0,20,0,0,.9])
...
ukf.P = np.diag([100,100,100,100,100,100,100,100,100,100])
ukf.Q = np.eye(dim_x) * .001
ukf.R = np.eye(dim_z) * 500000
steps=len(ig)
