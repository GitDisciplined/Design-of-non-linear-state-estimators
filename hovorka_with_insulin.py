...
axs[0,0].plot(time,ns2,label='truth')
axs[0,0].plot(time,est1,label='ukf')
axs[0,0].legend()
...
axs[0,1].plot(time,ns3,label='truth')
axs[0,1].plot(time,est2,label='ukf')
axs[0,1].legend()
...
axs[1,1].plot(time,ns,label='gut')
axs[1,1].plot(time,ns1,label='intestine')
axs[1,1].legend()
