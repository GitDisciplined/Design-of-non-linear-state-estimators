...
def initialize():
    ...
    X0=np.array([0,0,90,0,0,0,2,0,0,.9])
    Q=np.diag([1,1,0,0,1,1,1,1,1,1])
    R=9
    P0=np.diag([200,100,100,100,100,100,100,100,100,100])
...
#EGP=16.9
    ...
    state_estimate1.append(estimated_ns[0][2])
